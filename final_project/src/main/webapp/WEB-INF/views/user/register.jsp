		...
		<form action="/user/register" method="post" enctype="multipart/form-data" onsubmit="return joinCheck(this)" style="margin-top: 30px;">
			...
			<label for="inputEmail3" class="col-sm-2 col-form-label">프로필사진</label>
				<div class="col-sm-1" style="display: none;">
		  		...
		  		<div class="col-sm-1">
		  			<button class="btn btn-outline-warning" type="button" id="trigger" style="padding: 5px 230px;">File</button>
				</div>
			</div>
			...
			<div class="row mb-3" style="margin-top: 30px;">
	    		...
	    		<div class="col-sm">
	      			<button type="button" class="nameChk btn btn-outline-warning" id="nameChk" onclick="checkNickName()">닉네임 중복확인</button><br>
	  			</div>
	 		</div>
			<!-- nick_name ajax 중복체크 -->
