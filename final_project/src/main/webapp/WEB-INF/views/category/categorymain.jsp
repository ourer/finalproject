	         ...
	         <div class="col">
	            <div class="card h-100">
	               <c:if test="${svo.uuid == null}">
                     <img alt="기본대표사진" src="/upload/sgMain_default.jpg" class="card-img-top object-fit-cover border rounded" style="height: 250px">
	               </c:if>
	               <c:if test="${svo.uuid != null}">
	                  <img alt="소모임대표사진" src="/upload/sgMainUpload/${fn:replace(svo.dir,'\\','/')}/${svo.uuid}_${svo.name}" class="card-img-top object-fit-cover border rounded" style="height: 250px">
	               </c:if>
	               <div class="card-body">
