...
<body>
  ...
  <div class="container-fluid">
    <form class="d-flex" role="search" method="get" class="search-form" >
      <input class="form-control me-2 search-field" type="search" placeholder="관심사를 검색해보세요" value="${param.findStr }" name="findStr" aria-label="Search">
      <button class="btn btn-outline-warning search-submit" type="submit" name="btnFind" value = "검색"><i class="fa-solid fa-magnifying-glass"></i></button>
    </form>
  </div>
